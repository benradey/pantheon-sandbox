...
This is chapter 1 text. Here's more. Bananas.

xref:bananaChap2[Id-based to chapter 2.]
...
This xref also has no label: <<ben-target>>

Experiments:

xref:apple@banana:nonsense:chap2.adoc[antora syntax]

xref:chap2.adoc[lots, of, commas, and,now,no,spaces,var1=var2,apple=banana]
